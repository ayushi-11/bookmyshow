...
if($_POST['npas']===$_POST['npass'])
{
$sq2 = "update user set pass='$_POST[npass]' WHERE email='$umail'";
...
<?php if($_POST['npas']!==$_POST['npass']){ echo("new password doesn't match ");}
else
{echo("password changed ");}
?>
<form name="signin" onsubmit="inherit.php" method="post" action="c.php">
ENTER NEW PASSWORD                :<input type="password" name="npass" method="post"><br>
RE-ENTER NEW PASSWORD                :<input type="password" name="npas" method="post"><br>
