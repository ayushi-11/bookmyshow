...
$sq2 = "select email,uname,pass,number,address from user where email='$_POST[mail]' AND pass='$_POST[pass]'";
...
$sq2 = "insert into login values('$username','$uemail')";
...
<div id="header">
<h3 id="hello"> Hello <?php echo "$username"; ?> ! </h3>
  <div class="shell">
