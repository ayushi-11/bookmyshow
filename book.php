...
<div id="footer">
  <div class="shell">
 <form name="signup" onsubmit="" method="post" action="booked.php">
User Name:<br />
...
Event Id<br />
<input type="text" name="id" placeholder="Contact Number" method="post"><br /><br />
number of tickets<br />
<input type="number" name="qt" placeholder="1" method="post"><br /><br />
