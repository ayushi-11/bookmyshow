...
<div class="shell">
<h1> Sign In</h1><br><br>
<p>password or email id does not match</p>
<form name="signin" onsubmit="inherit.php" method="post" action="sighin.php">
E-mail                  :<input type="email" name="mail" id="qwe"> <br>
password                :<input type="password" name="pass" method="post"><br>
