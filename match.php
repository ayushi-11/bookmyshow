...
<div class="shell">
<h1> Sign Up</h1><br><br>
<p>ALLREADY REGISTERED WITH THIS EMAIL ADDRESS</p>
<div id="form">
<form name="signup" onsubmit="" method="post" action="filesd.php">
<br /><br />E-mail:<br />
<input type="email" name="email" placeholder="uvwxyz@pqr.com" method="post"><br /><br />
User Name:<br />
<input type="text" name="uname" placeholder="Last Name" method="post"><br /><br />
Passwoerd:<br />
<input type="password" name="pass" placeholder="Id" method="post"><br /><br />
Re-enter Password:<br />
<input type="password" name="pas" placeholder="Re-enter Password" method="post"><br /><br />
...
Contact Number:<br />
<input type="text" name="number" placeholder="Contact Number" method="post"><br /><br />
