...
<form name="sign" onsubmit="" method="post" action="ad.php">
<br /><br />
PLEASE ENTE THE ADMIN PASSWORD<br />
<input type="password" name="uname" placeholder="Last Name" method="post"><br /><br />
