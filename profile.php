...
<h1> BOOK</h1><br><br>
<ul>
        <li><a href="mov.php">MOVIES</a></li>
        <li><a href="conn.php" >CONCERTS</a></li>
        <li><a href="the.php">THEATRES</a></li>   
		<li><a href="fes.php">FESTS</a></li>
        <li><a href="changep.php">CHANGE PASSWORD</a></li>
		<li><a href="changea.php">CHANGE ADDRESS</li>
</ul>
