...
$sq2 = "insert into book(umail,Eid,QTY) values('$umail','$_POST[id]','$_POST[qt]') ";
...
<h3 id="hello"> Hello <?php echo "$uname"; ?> ! </h3>
  <div class="shell">
  <p>you have successfully booked the event(please check your mail for the payment options)</p>
